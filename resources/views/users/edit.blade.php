                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('users.update',$user->id) }}" method="post">
                        ...
                        <div> 
                            ...
                            <div class="my-3">
                                <input value="{{old('name', $user->name)}}" placeholder="Enter Role Name" type="text" name="name" id="" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('name')
                            ...
                            <div class="my-3">
                                <input value="{{old('name', $user->email)}}" placeholder="Enter Role Name" type="email" name="email" id="" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('name')
                                <p class="text-red-400">{{$message}}</p>
                            @enderror
                            </div>
